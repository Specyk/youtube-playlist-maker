...
(function() {
    ...
    const scan = (DOM, locationSelector) => Array.from(DOM.querySelectorAll(scanStrategies.get(locationSelector))); // return array of HTML elements
    ...
    const scanStrategies = new Map(Object.entries( // page path : selector
        {
            '/': '#video-title-link',
            'default': '#video-title'
        }
